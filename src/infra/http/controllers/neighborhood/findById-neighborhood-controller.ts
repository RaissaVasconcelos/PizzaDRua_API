import { MakeFindByIdNeighborhood } from '../../../factory/neignborhood/make-findById-neighborhood';
import { FastifyReply, FastifyRequest } from "fastify";
import * as z from 'zod'
import { ResourceNotFoundError } from '../../../../core/errors/resource-not-found-error';

export const FindByIdNeighborhoodController = async (request: FastifyRequest, reply: FastifyReply) => {
    ...
    const makeNeighborhood = MakeFindByIdNeighborhood()
